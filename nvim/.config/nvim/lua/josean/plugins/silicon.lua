return {
  ...
  opts = {
    ...
    font = 'MesloLGS Nerd Font Mono=16', -- (string) The font and font size to use for the screenshot.
    ...
    watermark = {
      text = 'UnEmotioneD', -- (string) The text to use as the watermark, set to nil to disable.
